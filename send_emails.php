...
/*
    //DEMO transaction email
    $link_activare_cont = "https://www.base.twoandfrom.com/index.php?view=b_acc_recover_confirm&tra=lkasdjskfhuihufasifiiue";
    $email = "sorin.dan@twoandfrom.com";
    $subject = "PLATFORM_NAME: "."Recuperare cont";
    $name = "Sorin Dan";
    $platform_name = "PLATFORM_NAME";
    $date = "2023-11-23 16:57:05";
    $mj = new \Mailjet\Client(MJ_APIKEY_PUBLIC, MJ_APIKEY_PRIVATE, true, ['version' => 'v3.1']);
    $body = [
        'Messages' => [
            [
